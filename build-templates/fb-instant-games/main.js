(function () {
    ...
    function boot() {
        ...
        var onStart = function () {
            ...
            cc.director.preloadScene(launchScene,
                function () {
                    console.log("pre load scene success")
                    loadGame();
                }
            );
    ...
    if (window.document) {
        var debug = window._CCSettings? window._CCSettings.debug : null;
    ...
    function loadGame() {
        let aArr = [
            // { path: "prefab/BlockUnit", type: cc.Prefab },
            // { path: "prefab/BlockUnit2", type: cc.Prefab },
            // { path: "prefab/StackUnit", type: cc.Prefab },
            // { path: "prefab/xiaochu02", type: cc.Prefab },
        ]
        let t_cnt = aArr.length;
        let _cnt = 0;
        ...
        // {
        //     let arg = aArr[i];
        //     cc.resources.load(arg.path, arg.type, function (err, asset)
        //     {
        //         // console.log("load asset complete : " + arg.path);
        //         _call();
        //     });
        // }
    }
    ...
    window.enterboot = function () {
        if (window.isFBSDKReady && window.isCocosEngineReady) {
